...
declare module "actions/action" {
    import { ILocalizableOwner, LocalizableString } from "entries/core";
    import { Base } from "base";
...
declare module "question_multipletext" {
    import { Base } from "base";
    import { ISurveyData, ISurveyImpl, ISurvey, IPanel, IElement, ITextProcessor, IProgressInfo } from "base-interfaces";
    import { SurveyValidator, IValidatorOwner } from "validator";
    import { Question, IConditionObject } from "question";
...
declare module "question_boolean" {
    ...
    export class QuestionBooleanModel extends Question {
         ...
         */
        valueFalse: any;
        private getValueTrue;
        private getValueFalse;
        protected setDefaultValue(): void;
...
declare module "question_custom" {
    import { Question, IConditionObject } from "question";
    import { ISurveyImpl, ISurveyData, ITextProcessor, IPanel, IElement } from "base-interfaces";
    import { SurveyElement } from "survey-element";
    import { PanelModel } from "panel";
    import { HashTable } from "helpers";
    import { ItemValue } from "itemvalue";
...
declare module "entries/chunks/model" {
    ...
    export { MatrixDropdownCell, MatrixDropdownRowModelBase, QuestionMatrixDropdownModelBase } from "question_matrixdropdownbase";
...
declare module "defaultCss/cssbootstrapmaterial" {
